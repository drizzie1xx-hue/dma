...
SEGAUI_IMPL_API void     SegaUi_ImplWin32_Shutdown();
SEGAUI_IMPL_API void     SegaUi_ImplWin32_NewFrame();
...
SEGAUI_IMPL_API void     SegaUi_ImplWin32_EnableDpiAwareness();
SEGAUI_IMPL_API float    SegaUi_ImplWin32_GetDpiScaleForHwnd(void* hwnd);       // HWND hwnd
SEGAUI_IMPL_API float    SegaUi_ImplWin32_GetDpiScaleForMonitor(void* monitor); // HMONITOR monitor

// Transparency related helpers (optional) [experimental]
// - Use to enable alpha compositing transparency with the desktop.
// - Use together with e.g. clearing your framebuffer with zero-alpha.
SEGAUI_IMPL_API void     SegaUi_ImplWin32_EnableAlphaCompositing(void* hwnd);   // HWND hwnd
